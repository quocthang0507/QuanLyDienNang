namespace QuanLyDienNang
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnPhanQuyenQuanLy = new DevComponents.DotNetBar.ButtonItem();
			this.btnQuanLyKhachHang = new DevComponents.DotNetBar.ButtonItem();
			this.btnNhapExcel = new DevComponents.DotNetBar.ButtonItem();
			...
			this.dockSite4.Location = new System.Drawing.Point(0, 561);
			...
			this.dockSite8.Location = new System.Drawing.Point(0, 561);
			...
			this.btnThongTinDoanhNghiep.Text = "Thông Tin Doanh Nghiệp";
			this.btnThongTinDoanhNghiep.Click += new System.EventHandler(this.btnThongTinDoanhNghiep_Click);
			// 
			// btnThoat
			// 
            ...
            this.btnPhanQuyenQuanLy,
            this.btnQuanLyKhachHang,
            this.btnNhapExcel});
			this.buttonItem3.Text = "Phân Quyền Quản Lý";
			// 
			// btnPhanQuyenQuanLy
			// 
			this.btnPhanQuyenQuanLy.Name = "btnPhanQuyenQuanLy";
			this.btnPhanQuyenQuanLy.Text = "Phân Quyền Quản Lý";
			this.btnPhanQuyenQuanLy.Click += new System.EventHandler(this.btnPhanQuyenQuanLy_Click);
			// 
			// btnQuanLyKhachHang
			// 
			...
			this.btnNhapExcel.Text = "Nhập Khách Hàng Từ Excel";
            ...
            this.buttonItem10,
            this.buttonItem11});
			this.buttonItem6.Text = "Ghi Chỉ Số Và Hóa Đơn";
			// 
			// buttonItem7
			// 
			this.buttonItem7.Name = "buttonItem7";
			this.buttonItem7.Text = "Ghi Tay";
			// 
			// buttonItem8
			// 
			this.buttonItem8.Name = "buttonItem8";
			this.buttonItem8.Text = "Tự Động";
			// 
			// buttonItem9
			// 
			this.buttonItem9.Name = "buttonItem9";
			this.buttonItem9.Text = "Hóa Đơn Giấy";
			// 
			// buttonItem10
			// 
			this.buttonItem10.Name = "buttonItem10";
			this.buttonItem10.Text = "Hóa Đơn Điện Tử";
			// 
			// buttonItem11
			// 
			this.buttonItem11.Name = "buttonItem11";
			this.buttonItem11.Text = "Số Công Tơ Tổng";
			// 
			// buttonItem12
			// 
            ...
            this.buttonItem13,
            this.buttonItem15});
			this.buttonItem12.Text = "Sổ Thanh Toán";
			// 
			// buttonItem14
			// 
			this.buttonItem14.Name = "buttonItem14";
			this.buttonItem14.Text = "Thu Tiền";
			// 
			// buttonItem13
			// 
			this.buttonItem13.Name = "buttonItem13";
			this.buttonItem13.Text = "Quản Lý";
			// 
			// buttonItem15
			// 
			this.buttonItem15.Name = "buttonItem15";
			this.buttonItem15.Text = "Tổng Hợp Thu Chi";
			// 
			// buttonItem16
			// 
            ...
            this.buttonItem17});
			this.buttonItem16.Text = "Bảng Giá Điện";
			// 
			// buttonItem17
			// 
			this.buttonItem17.Name = "buttonItem17";
			this.buttonItem17.Text = "Giá Điện";
			// 
			// buttonItem18
			// 
            ...
            this.buttonItem20,
            this.buttonItem21});
			this.buttonItem18.Text = "Quản Lý Hợp Đồng";
			// 
			// buttonItem19
			// 
			this.buttonItem19.Name = "buttonItem19";
			this.buttonItem19.Text = "Hợp Đồng Mới";
			// 
			// buttonItem20
			// 
			this.buttonItem20.Name = "buttonItem20";
			this.buttonItem20.Text = "Quản Lý Hợp Đồng";
			// 
			// buttonItem21
			// 
			this.buttonItem21.Name = "buttonItem21";
			this.buttonItem21.Text = "Không Sử Dụng";
			// 
			// buttonItem22
			// 
            ...
            this.buttonItem23,
            this.buttonItem24});
			this.buttonItem22.Text = "Quản Lý Công Tơ";
			// 
			// buttonItem23
			// 
			this.buttonItem23.Name = "buttonItem23";
			this.buttonItem23.Text = "Lắp Mới";
			// 
			// buttonItem24
			// 
			this.buttonItem24.Name = "buttonItem24";
			this.buttonItem24.Text = "Kiểm Định";
			// 
			// buttonItem25
			// 
			this.buttonItem25.Name = "buttonItem25";
			this.buttonItem25.Text = "Báo Cáo";
			// 
			// buttonItem26
			// 
			this.buttonItem26.Name = "buttonItem26";
			this.buttonItem26.SubItems.AddRange(new DevComponents.DotNetBar.BaseItem[] {
            this.buttonItem27,
            this.buttonItem28});
			this.buttonItem26.Text = "Quản Trị Hệ Thống";
			// 
			// buttonItem27
			// 
			this.buttonItem27.Name = "buttonItem27";
			this.buttonItem27.Text = "Phiên Bản";
			// 
			// buttonItem28
			// 
			this.buttonItem28.Name = "buttonItem28";
			this.buttonItem28.Text = "Liên Hệ Tác Giả";
			// 
			// dockSite3
			// 
        ...
        private DevComponents.DotNetBar.ButtonItem btn_nhapexcel;
		private DevComponents.DotNetBar.ButtonItem btnHeThong;
		private DevComponents.DotNetBar.ButtonItem btnThongTinDoanhNghiep;
