USE MASTER
GO CREATE DATABASE QuanLyDienNang
GO USE QuanLyDienNang
GO --BẢNG GIÁ ÁP DỤNG CHO KHÁCH HÀNG
	CREATE TABLE BangGia (
		--BG001
		MaBangGia char(5) primary key,
		TenBangGia nvarchar(100) not null
	)
GO --TRẠM BIẾN ÁP ÁP DỤNG CHO KHÁCH HÀNG
	CREATE TABLE TramBienAp (
		--BA001
		MaTram char(5) primary key,
		TenTram nvarchar(100) not null
	)
GO --NGƯỜI QUẢN LÝ KHÁCH HÀNG
...
GO --THÔNG TIN ĐIỆN NĂNG TIÊU THỤ CỦA KHÁCH HÀNG
